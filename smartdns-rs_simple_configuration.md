...
```sh
curl -O https://cdn.jsdelivr.net/gh/Loyalsoldier/v2ray-rules-dat@release/reject-list.txt
```

执行后会在脚本所在的目录中生成 `reject-list.txt` 文件。
...
server-https https://223.5.5.5/dns-query -group china
server-https https://223.6.6.6/dns-query -group china
server-https https://1.1.1.1/dns-query -group oversea
server-https https://1.0.0.1/dns-query -group oversea
...
nameserver /microsoft.com/china
nameserver /bito.ai/china
nameserver /deepl.com/china
nameserver /jsdelivr.net/china
nameserver /tencentgamededicatednetwork.com/china

nameserver /google.com/oversea
nameserver /bing.com/oversea
...
domain-set -name reject -file reject-list.txt
